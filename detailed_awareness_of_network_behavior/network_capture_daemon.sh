...
while true; do
    ...
    -e tcp.flags.ack -e tcp.flags.reset -e tcp.flags.push -e tcp.flags.urg \
    ...
    -e ssl.handshake.ciphersuite -e ssl.record.content_type \
    ...
    -e http.user_agent -e http.content_type -e http.response_in -e http.content_length \
